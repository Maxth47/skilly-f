    ...
    <section id="hero" className="relative pt-24 pb-12 md:pt-32 md:pb-20">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="flex flex-col items-center text-center">
          <AnimateOnScroll animation="fade-in-up" duration={0.6} delay={0.1}>
          ...
          <AnimateOnScroll animation="fade-in-up" duration={0.8} delay={0.2}>
          ...
          <AnimateOnScroll animation="fade-in-up" duration={0.7} delay={0.35}>
        ...
        <AnimateOnScroll animation="scale-in" duration={0.9} delay={0.6}>
